...
def init(soma=None):
    ...
    capture_service = cv2.VideoCapture("cut.mp4")
    ...
    while cv2.waitKey(1) != 27:
        ...
        for (classid, acuracia, box) in zip(classes, acuracias, boxes):
            ...
            if (acuracia > 0.75) & send_message:
                ...
                imagePath = f"/home/ronaldo/PycharmProjects/log-images/{str(date)}.jpg"
    ...
    avg_acuracia = acumulador / contador
    print(f"Media de certeza: {avg_acuracia}")